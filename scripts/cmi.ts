...
console.log(
  `Indexed: ${report.counts.total} units ` +
    `(${report.counts.colleges} colleges, ${report.counts.exams} exams, ${report.counts.regions} regions, ${report.counts.guides} guides, ${report.counts.topics} topics, ${report.counts.tracks} tracks)`,
);
