...
export default function FeedbackModal({
  ...
  // back to the UA font) ──
  const inputCls =
    'mt-1.5 w-full rounded-xl border bg-white px-3 py-2.5 font-sans text-sm text-stone-800 placeholder:text-stone-500 focus:outline-none focus:border-forest-600';
