            ...
            */}
            ...
            <label htmlFor="tester-invite-email" className="block mt-4">
              ...
              <input
                ...
                className={`mt-1.5 w-full rounded-xl border bg-white px-3 py-2.5 font-sans text-base sm:text-sm text-stone-800 placeholder:text-stone-500 focus:outline-none ${
                  showError
