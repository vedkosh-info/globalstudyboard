...
export const REGIONS: Region[] = [
  ...
  },
  {
    ...
    popularQueries: [
      ...
      'a-levels-required-for-russell-group',
      'graduate-route-visa-uk',
      'ireland-stamp-2-permission',
      'oxbridge-tsa-interview',
    ],
  ...
  },
  {
    ...
    worksWhileStudying: 'Typically 20 hrs/week or 120 full days per year. Post-study work visas: Germany 18 months, Netherlands 1 year, France 1-2 years.',
  },
  {
    slug: 'australia-nz',
  ...
  },
  {
    ...
    popularQueries: [
      ...
      'mbbs-in-russia-recognized-india-usa',
      'russia-student-visa-process',
      'top-english-taught-universities-russia',
    ],
    intakes: ['September'],
    averageTuitionRangeUsd: { undergrad: [3000, 12000], grad: [3500, 14000] },
    visaName: 'Russian Student Visa (type O)',
    worksWhileStudying: 'Allowed only with work permit; specific exemption for students of state universities.',
  },
  {
    slug: 'middle-east',
    ...
    popularQueries: [
      ...
      'kaust-fellowship',
      'student-visa-uae-process',
      'tuition-free-universities-middle-east',
    ],
    intakes: ['Fall (Aug/Sep)', 'Spring (Jan)'],
