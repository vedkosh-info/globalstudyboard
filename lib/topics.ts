...
export type TopicGroup =
  ...
  | 'study-in-asia' // East & Southeast Asia destination hubs (shown only when that region is selected)
...
export const TOPIC_GROUP_LABELS: Record<TopicGroup, string> = {
  ...
  'study-in-asia': 'Study in East & Southeast Asia',
...
export interface Topic {
  ...
  intro?: string;
  /**
   * Query-shaped <title>/og:title when `title` is an internal batch label (e.g.
   * "Even More Japanese Universities" — a label that matches no search query).
   * The H1 stays `title`; only the SERP title uses this.
   */
  seoTitle?: string;
  group: TopicGroup;
  /**
...
/* ==EASTASIA_HUBS_P4_START== */
  {"slug":"japan-even-more-universities","label":"Japan: More Unis II","title":"Even More Japanese Universities","seoTitle":"Sophia, Meiji, Rikkyo & Doshisha: Admission Guides for International Students","description":"International-admission guides for more of Japan’s well-known universities — English and Japanese-track entry.","group":"study-in-asia","region":"east-southeast-asia","guideSlugs":["sophia-university-admission-guide","meiji-university-admission-guide","rikkyo-university-admission-guide","doshisha-university-admission-guide","ritsumeikan-university-admission-guide","kanazawa-university-admission-guide","okayama-university-admission-guide","nagoya-institute-of-technology-admission-guide"],"examSlugs":["ielts","toefl"],"keywords":["sophia meiji rikkyo","doshisha ritsumeikan","study in japan universities"]},
  {"slug":"korea-even-more-universities","label":"Korea: More Unis II","title":"Even More Korean Universities","seoTitle":"Sejong, Konkuk, Kyungpook & Chonnam: Korean University Admission Guides","description":"International-admission guides for more of Korea’s well-known universities.","group":"study-in-asia","region":"east-southeast-asia","guideSlugs":["sejong-university-admission-guide","konkuk-university-admission-guide","kyungpook-national-university-admission-guide","chonnam-national-university-admission-guide","ajou-university-admission-guide","dongguk-university-admission-guide","hongik-university-admission-guide","other-flagship-national-universities-in-korea-admission-guide"],"examSlugs":["ielts","toefl"],"keywords":["sejong konkuk hongik","kyungpook chonnam","study in korea universities"]},
  {"slug":"china-even-more-universities","label":"China: More Unis II","title":"Even More Chinese Universities","seoTitle":"Beihang, BIT, Southeast & Central South: Chinese University Admission Guides","description":"International-admission guides for more of China’s leading universities — neutral, study-facts only.","group":"study-in-asia","region":"east-southeast-asia","guideSlugs":["beihang-university-admission-for-international-students","beijing-institute-of-technology-admission-for-international-students","southeast-university-nanjing-admission-for-international-students","central-south-university-admission-for-international-students","sichuan-university-admission-for-international-students","jilin-university-admission-for-international-students","shandong-university-admission-for-international-students","dalian-university-of-technology-admission-for-international-students"],"examSlugs":["ielts","toefl"],"keywords":["beihang bit southeast","sichuan jilin shandong","study in china universities"]},
  {"slug":"taiwan-more-universities-and-programs","label":"Taiwan: More Unis","title":"More Taiwanese Universities & Programs","seoTitle":"NCCU, Taipei Tech, Feng Chia & Ocean University: Taiwan Admission Guides","description":"International-admission guides for more of Taiwan’s universities and English-taught programs.","group":"study-in-asia","region":"east-southeast-asia","guideSlugs":["national-chengchi-university-nccu-admission-guide","national-taipei-university-of-technology-taipei-tech-admission-guide","feng-chia-university-admission-guide","national-taiwan-ocean-university-admission-guide","yuan-ze-university-admission-guide","studying-semiconductors-and-ic-design-in-taiwan","public-vs-private-universities-in-taiwan"],"examSlugs":["ielts","toefl"],"keywords":["nccu taipei tech","feng chia yuan ze","study in taiwan universities"]},
  {"slug":"malaysia-more-universities-and-colleges","label":"Malaysia: More Institutions","title":"More Malaysian Universities & Colleges","seoTitle":"UNIMAS, UMS, UCSI, MSU & SEGi: Malaysian University Admission Guides","description":"International-admission guides for more of Malaysia’s public and private institutions.","group":"study-in-asia","region":"east-southeast-asia","guideSlugs":["universiti-malaysia-sarawak-unimas-admission-guide","universiti-malaysia-sabah-ums-admission-guide","ucsi-university-admission-guide","management-and-science-university-msu-admission-guide","segi-university-admission-guide","university-college-vs-university-status-in-malaysia-explained","studying-in-east-malaysia-sarawak-and-sabah","other-private-universities-and-colleges-in-malaysia-shortlisting-guide"],"examSlugs":["ielts","toefl"],"keywords":["unimas ums ucsi","msu segi malaysia","study in malaysia"]},
  {"slug":"more-southeast-asia-universities","label":"PH & TH: More Unis","title":"More Philippines & Thailand Universities","seoTitle":"Mapúa, FEU, Silliman & San Carlos: Philippines & Thailand University Guides","description":"International-admission guides for more universities in the Philippines and Thailand.","group":"study-in-asia","region":"east-southeast-asia","guideSlugs":["mapua-university-admission-guide","far-eastern-university-feu-admission-guide","silliman-university-admission-guide","university-of-san-carlos-admission-guide","kmutt-international-programs-admission-guide","prince-of-songkla-university-international-programs-admission-guide","studying-in-cebu-student-life-and-universities","studying-in-bangkok-student-life-and-universities"],"examSlugs":["ielts","toefl"],"keywords":["mapua feu silliman","kmutt chiang mai kasetsart","universities philippines thailand"]},
  {"slug":"asia-dentistry-veterinary-and-pharmacy","label":"Dentistry, Vet & Pharmacy","title":"Dentistry, Veterinary & Pharmacy Study in Asia","description":"Studying dentistry, veterinary science and pharmacy across Asia — study routes only, India-side to practise.","group":"study-in-asia","region":"east-southeast-asia","guideSlugs":["practising-dentistry-veterinary-or-pharmacy-in-india-after-a-foreign-degree","studying-dentistry-dmd-in-the-philippines","pharmd-vs-bpharm-degree-routes-in-asia","studying-pharmacy-in-malaysia-and-registering-as-a-pharmacist","studying-veterinary-medicine-dvm-in-the-philippines"],"examSlugs":["ielts","toefl"],"keywords":["dentistry in asia","veterinary asia","pharmacy study asia"]},
  {"slug":"asia-nursing-and-allied-health-by-country","label":"Nursing by Country","title":"Nursing & Allied Health in Asia, by Country","description":"Studying nursing and allied health in Asia, country by country — study routes only.","group":"study-in-asia","region":"east-southeast-asia","guideSlugs":["registering-as-a-nurse-in-india-after-a-foreign-nursing-degree","studying-nursing-in-taiwan","studying-nursing-in-china-for-indian-students","english-taught-nursing-degrees-in-asia-what-to-know","working-as-a-nurse-in-asia-after-graduating","medical-laboratory-and-imaging-technology-studies-across-asia"],"examSlugs":["ielts","toefl"],"keywords":["nursing in asia by country","allied health asia","nursing philippines japan korea"]},
  {"slug":"asia-maritime-aviation-and-logistics","label":"Maritime, Aviation & Logistics","title":"Maritime, Aviation & Logistics Studies in Asia","description":"Studying maritime, aviation and logistics fields across Asia.","group":"study-in-asia","region":"east-southeast-asia","guideSlugs":["studying-naval-architecture-and-ocean-engineering-across-asia","aviation-management-and-airline-business-studies-across-asia","port-shipping-and-maritime-logistics-studies-across-asia","maritime-and-shipping-studies-in-singapore","seafarer-training-and-dg-shipping-recognition-for-studying-in-asia","aviation-management-vs-aerospace-engineering-how-to-choose","logistics-and-maritime-studies-in-hong-kong","maritime-and-shipping-studies-in-china"],"examSlugs":["ielts","toefl"],"keywords":["maritime studies asia","aviation management asia","logistics supply chain asia"]},
  {"slug":"asia-hospitality-tourism-and-culinary","label":"Hospitality & Culinary","title":"Hospitality, Tourism & Culinary Studies in Asia","description":"Studying hospitality, tourism and culinary arts across Asia.","group":"study-in-asia","region":"east-southeast-asia","guideSlugs":["studying-culinary-arts-and-chef-training-in-asia","swiss-and-european-linked-hospitality-schools-in-asia","studying-hospitality-and-tourism-in-thailand","studying-hospitality-and-culinary-arts-in-malaysia","studying-event-and-mice-management-in-asia","careers-in-hospitality-tourism-and-culinary-arts-after-studying-in-asia"],"examSlugs":["ielts","toefl"],"keywords":["hospitality management asia","culinary arts asia","tourism studies asia"]},
  {"slug":"asia-emerging-tech-and-engineering-specialisations","label":"Emerging Tech & Eng II","title":"Emerging Tech & Engineering Specialisations in Asia","description":"Specialised and emerging engineering and technology fields across Asia.","group":"study-in-asia","region":"east-southeast-asia","guideSlugs":["robotics-and-mechatronics-engineering-across-asia","semiconductor-and-microelectronics-engineering-across-asia","renewable-energy-and-power-engineering-across-asia","biotechnology-and-bioengineering-degrees-across-asia","automotive-and-electric-vehicle-engineering-across-asia","materials-science-and-engineering-across-asia","quantum-technology-and-computing-degrees-across-asia","marine-ocean-and-offshore-engineering-across-asia"],"examSlugs":["ielts","toefl","gre"],"keywords":["robotics asia","semiconductors asia","renewable energy engineering asia","biotech asia"]},
  {"slug":"asia-social-sciences-humanities-and-law","label":"Social Sciences & Law","title":"Social Sciences, Humanities & Law in Asia","description":"Studying the social sciences, humanities and law across Asia.","group":"study-in-asia","region":"east-southeast-asia","guideSlugs":["studying-law-llb-and-llm-across-asia","studying-international-relations-and-political-science-across-asia","studying-psychology-across-asia","studying-economics-across-asia","studying-sociology-and-anthropology-across-asia","studying-education-and-teaching-degrees-across-asia","studying-public-policy-and-public-administration-across-asia","careers-and-directions-after-a-law-or-social-sciences-degree-in-asia"],"examSlugs":["ielts","toefl"],"keywords":["law in asia","international relations asia","psychology study asia","economics asia"]},
  {"slug":"asia-agriculture-environment-and-marine","label":"Agriculture & Environment","title":"Agriculture, Environment & Marine Sciences in Asia","description":"Studying agriculture, environmental and marine sciences across Asia.","group":"study-in-asia","region":"east-southeast-asia","guideSlugs":["studying-agriculture-and-agri-tech-across-asia","studying-marine-science-and-fisheries-across-asia","studying-food-science-and-nutrition-across-asia","studying-forestry-and-natural-resource-management-across-asia","studying-environmental-engineering-across-asia","studying-ecology-and-conservation-biology-across-asia"],"examSlugs":["ielts","toefl"],"keywords":["agriculture study asia","environmental science asia","marine science asia","food science asia"]},
  {"slug":"asia-more-scholarships-and-corporate-funding","label":"More Scholarships","title":"More Scholarships & Corporate Funding in Asia","seoTitle":"Corporate, ADB-JSP & Need-Based Scholarships for Studying in Asia","description":"Beyond the flagship government scholarships — corporate, foundation and need-based funding across Asia.","group":"study-in-asia","region":"east-southeast-asia","guideSlugs":["corporate-and-company-sponsored-scholarships-in-asia","adb-japan-scholarship-program-guide","need-based-financial-aid-and-bursaries-at-asian-universities","building-a-competitive-scholarship-application-for-asia","schwarzman-scholars-and-yenching-academy-china-guide","singapore-international-graduate-award-singa-guide","tuition-waivers-and-assistantships-for-self-funded-students-in-asia","what-scholarships-actually-cover-tuition-stipend-and-fine-print"],"examSlugs":["ielts","toefl"],"keywords":["corporate scholarships asia","need-based aid asia","assistantships asia"]},
  {"slug":"asia-affordable-study-and-budgeting","label":"Affordable Study","title":"Affordable Study & Budgeting in Asia","description":"The most affordable ways to study in Asia and how to budget.","group":"study-in-asia","region":"east-southeast-asia","guideSlugs":["how-to-calculate-the-total-cost-of-a-degree-in-asia","proof-of-funds-and-financial-requirements-for-asian-student-visas","can-part-time-work-cover-your-living-costs-while-studying-in-asia","sending-money-and-managing-currency-as-a-student-in-asia","low-tuition-universities-in-asia-and-how-fees-are-set","cutting-living-costs-and-student-discounts-across-asia"],"examSlugs":["ielts","toefl"],"keywords":["cheapest study in asia","budgeting study asia","affordable universities asia"]},
  {"slug":"asia-student-cities-living-guides","label":"Student Cities","title":"Living as a Student in Asia’s Cities","description":"What it is like to live and study in Asia’s major student cities.","group":"study-in-asia","region":"east-southeast-asia","guideSlugs":["living-as-a-student-in-kyoto","living-as-a-student-in-fukuoka","living-as-a-student-in-busan","living-as-a-student-in-kuala-lumpur","living-as-a-student-in-bangkok","living-as-a-student-in-taipei","living-as-a-student-in-beijing","living-as-a-student-in-shanghai"],"examSlugs":["ielts","toefl"],"keywords":["living in kyoto student","living in kuala lumpur student","student cities asia"]},
  {"slug":"asia-english-taught-degrees-by-country","label":"English-Taught by Country","title":"English-Taught Degrees in Asia, by Country","description":"Where to find English-taught degrees in each Asian destination.","group":"study-in-asia","region":"east-southeast-asia","guideSlugs":["english-taught-degrees-in-malaysia","english-taught-degrees-in-hong-kong","english-medium-degrees-in-the-philippines-beyond-medicine","how-to-verify-a-degree-is-fully-english-taught-in-asia","how-to-find-english-taught-programs-in-asia-using-official-databases","local-language-and-jobs-after-an-english-taught-degree-in-asia"],"examSlugs":["ielts","toefl"],"keywords":["english-taught degrees japan","english programs korea china","study in english asia"]},
  {"slug":"asia-intakes-deadlines-and-application-planning","label":"Intakes & Deadlines","title":"Intakes, Deadlines & Application Planning for Asia","description":"Planning your Asian application around intakes and deadlines, country by country.","group":"study-in-asia","region":"east-southeast-asia","guideSlugs":["japan-university-intakes-and-application-timeline-planning","south-korea-university-intakes-and-application-timeline","china-university-intakes-and-application-deadline-planning","singapore-university-intake-and-application-timeline","malaysia-multiple-intakes-and-when-to-apply","taiwan-fall-and-spring-intakes-application-planning","hong-kong-intake-calendar-and-application-deadlines","thailand-and-philippines-academic-calendar-and-application-timing"],"examSlugs":["ielts","toefl"],"keywords":["intakes deadlines asia","when to apply japan korea","application timeline asia"]},
  {"slug":"asia-which-destination-for-your-field","label":"Which Country for Your Field","title":"Which Asian Destination for Your Field of Study","description":"Neutral, decide-by-your-field guides to choosing an Asian destination.","group":"study-in-asia","region":"east-southeast-asia","guideSlugs":["matching-your-field-of-study-to-a-study-destination-in-asia","where-to-study-in-asia-if-you-are-undecided-about-your-major","where-to-study-law-in-east-and-southeast-asia","where-to-study-for-a-semiconductor-career-in-asia","switching-your-field-of-study-for-a-masters-in-asia"],"examSlugs":["ielts","toefl"],"keywords":["which country for engineering asia","best country business asia","where to study medicine asia"]},
  {"slug":"asia-health-safety-and-wellbeing","label":"Health, Safety & Wellbeing","title":"Health, Safety & Wellbeing for Students in Asia","description":"The health, safety and wellbeing side of studying in Asia.","group":"study-in-asia","region":"east-southeast-asia","guideSlugs":["student-health-insurance-and-healthcare-systems-across-asia","bringing-prescription-medication-into-asian-countries-explained","mental-health-and-wellbeing-support-for-students-in-asia","staying-safe-as-an-international-student-in-asia","earthquake-typhoon-and-natural-hazard-preparedness-for-students-in-asia","vegetarian-jain-and-halal-food-for-students-in-asia","climate-seasons-and-what-to-pack-for-studying-in-asia","medical-check-up-and-health-screening-for-asian-student-visas"],"examSlugs":["ielts","toefl"],"keywords":["student health insurance asia","wellbeing students asia","vegetarian halal food asia","safety students asia"]},
/* ==EASTASIA_HUBS_P4_END== */
/* ==EASTASIA_HUBS_P3_START== */
  {"slug":"japan-more-universities-and-programs","label":"Japan: More Universities","title":"More Japanese Universities & Programs","seoTitle":"Kobe, Hiroshima, Chiba & Tokyo Metropolitan: Japanese University Admission Guides","description":"Admission guides for more of Japan’s strong universities beyond the biggest names — with English (SGU) and Japanese-track entry.","group":"study-in-asia","region":"east-southeast-asia","guideSlugs":["kobe-university-admission-guide","hiroshima-university-admission-guide","chiba-university-admission-guide","tokyo-metropolitan-university-admission-guide","tuat-and-yokohama-national-university-admission-guide"],"examSlugs":["ielts","toefl"],"keywords":["kobe university admission","hiroshima university","study in japan universities"]},
  {"slug":"japan-professional-and-creative-fields","label":"Japan: More Fields","title":"Professional & Creative Fields in Japan","description":"Studying specific professional and creative subjects in Japan — nursing, pharmacy, architecture, animation and game design, and agriculture and veterinary science.","group":"study-in-asia","region":"east-southeast-asia","guideSlugs":["studying-nursing-and-healthcare-in-japan","studying-pharmacy-in-japan","studying-animation-manga-and-game-design-in-japan","studying-agriculture-and-veterinary-science-in-japan","studying-aviation-and-aerospace-in-japan"],"examSlugs":["ielts","toefl"],"keywords":["nursing in japan","animation game design japan","architecture japan"]},
  {"slug":"singapore-postgrad-and-professional-fields","label":"Singapore: PG & Fields","title":"Postgraduate & Professional Fields in Singapore","description":"Postgraduate study and professional subjects in Singapore — master’s and PhD routes, nursing and allied health, law, architecture, and data science and AI.","group":"study-in-asia","region":"east-southeast-asia","guideSlugs":["phd-and-research-degrees-in-singapore-guide","nursing-and-allied-health-study-in-singapore","study-architecture-in-singapore","data-science-and-ai-masters-in-singapore","qualifying-to-practise-law-in-singapore-for-foreign-graduates"],"examSlugs":["ielts","toefl","gre","gmat"],"keywords":["masters phd singapore","nursing singapore","data science singapore"]},
  {"slug":"korea-more-universities","label":"Korea: More Universities","title":"More Korean Universities","seoTitle":"Chung-Ang, Ewha, Sogang, UNIST & GIST: Korean University Admission Guides","description":"Admission guides for more of Korea’s strong universities beyond SKY and KAIST/POSTECH.","group":"study-in-asia","region":"east-southeast-asia","guideSlugs":["chung-ang-university-admission-guide","ewha-womans-university-admission-guide","sogang-university-admission-guide","unist-and-gist-admission-guide","pusan-national-university-and-inha-university-admission-guide"],"examSlugs":["ielts","toefl"],"keywords":["chung-ang ewha sogang","unist gist","study in korea universities"]},
  {"slug":"korea-professional-and-creative-fields","label":"Korea: More Fields","title":"Professional & Creative Fields in South Korea","description":"Studying specific professional and creative subjects in South Korea — nursing, media and K-content, film, and specialised engineering and business tracks.","group":"study-in-asia","region":"east-southeast-asia","guideSlugs":["studying-nursing-in-south-korea","studying-film-and-performing-arts-in-south-korea","studying-semiconductor-and-electronics-engineering-in-south-korea","global-mba-in-south-korea-guide","studying-fashion-and-beauty-design-in-south-korea"],"examSlugs":["ielts","toefl"],"keywords":["nursing in korea","k-content media study korea","film study korea"]},
  {"slug":"hong-kong-fields-and-student-life-in-depth","label":"Hong Kong: Fields & Life","title":"Hong Kong: Fields, More Universities & Student Life","description":"Deeper Hong Kong content — fields of study, Lingnan and EdUHK, more scholarships, and the practicalities of student life.","group":"study-in-asia","region":"east-southeast-asia","guideSlugs":["lingnan-university-admission-guide","education-university-of-hong-kong-admission-guide","fields-of-study-and-strong-subjects-in-hong-kong","university-entrance-scholarships-in-hong-kong-explained","student-life-and-part-time-work-in-hong-kong"],"examSlugs":["ielts","toefl"],"keywords":["study in hong kong fields","lingnan eduhk","hong kong student life"]},
  {"slug":"taiwan-fields-programs-and-life-in-depth","label":"Taiwan: Fields & Life","title":"Taiwan: Fields, More Universities & Student Life","description":"Deeper Taiwan content — fields of study, more universities, English- vs Mandarin-taught degrees, and student life.","group":"study-in-asia","region":"east-southeast-asia","guideSlugs":["national-chung-hsing-university-admission-guide","national-central-university-taiwan-admission-guide","national-sun-yat-sen-university-admission-guide","choosing-a-field-of-study-in-taiwan","student-life-and-accommodation-in-taiwan"],"examSlugs":["ielts","toefl"],"keywords":["study in taiwan fields","english-taught taiwan","taiwan student life"]},
  {"slug":"malaysia-fields-pathways-and-life-in-depth","label":"Malaysia: Fields & Pathways","title":"Malaysia: Fields, Pathways & Student Life","description":"Deeper Malaysia content — fields of study, twinning and 3+0 pathways, more institutions, and student life.","group":"study-in-asia","region":"east-southeast-asia","guideSlugs":["multimedia-university-mmu-admission-guide","universiti-teknologi-petronas-utp-admission-guide","inti-international-university-admission-guide","twinning-3-plus-0-and-adp-pathways-in-malaysia","mqa-accreditation-and-checking-a-malaysian-degree"],"examSlugs":["ielts","toefl"],"keywords":["study in malaysia fields","twinning 3+0 malaysia","multimedia university utp"]},
  {"slug":"china-more-universities","label":"China: More Universities","title":"More Chinese Universities","seoTitle":"Wuhan, Xi'an Jiaotong, Harbin & Tongji: Chinese University Admission Guides","description":"Admission guides for more of China’s leading universities — neutral, study-facts only.","group":"study-in-asia","region":"east-southeast-asia","guideSlugs":["wuhan-university-admission-for-international-students","xian-jiaotong-university-admission-for-international-students","harbin-institute-of-technology-admission-for-international-students","tongji-university-admission-for-international-students","sun-yat-sen-university-admission-for-international-students"],"examSlugs":["ielts","toefl"],"keywords":["wuhan xjtu hit admission","renmin tongji","study in china universities"]},
  {"slug":"china-fields-and-language-in-depth","label":"China: Fields & Language","title":"China: Fields of Study & Chinese Language","description":"Studying specific fields in China and learning Chinese — neutral, study-facts only.","group":"study-in-asia","region":"east-southeast-asia","guideSlugs":["studying-engineering-and-computer-science-in-china","studying-business-and-economics-in-china","chinese-language-study-programs-in-china","chinese-taught-vs-english-taught-degrees-in-china","hsk-level-required-for-degree-admission-in-china"],"examSlugs":["ielts","toefl"],"keywords":["study fields in china","learn chinese in china","hsk for degree"]},
  {"slug":"philippines-universities-nursing-and-life","label":"Philippines: Unis & Nursing","title":"Philippines: Universities, Nursing & Student Life","description":"Deeper Philippines content — universities, nursing and allied health, and the practicalities of studying there.","group":"study-in-asia","region":"east-southeast-asia","guideSlugs":["allied-health-and-paramedical-courses-in-the-philippines","state-vs-private-universities-in-the-philippines","verifying-a-ched-recognised-university-in-the-philippines","studying-in-metro-manila-student-life-and-accommodation","maritime-education-and-merchant-navy-studies-in-the-philippines"],"examSlugs":["ielts","toefl"],"keywords":["universities in philippines","nursing in philippines","study in philippines life"]},
  {"slug":"thailand-universities-programs-and-life","label":"Thailand: Unis & Life","title":"Thailand: Universities, Programs & Student Life","description":"Deeper Thailand content — universities, international programs, fields and student life.","group":"study-in-asia","region":"east-southeast-asia","guideSlugs":["chiang-mai-university-international-programs-admission-guide","kasetsart-university-international-programs-admission-guide","english-taught-programs-in-thailand-by-field","cost-of-studying-in-thailand","student-life-and-accommodation-in-thailand"],"examSlugs":["ielts","toefl"],"keywords":["universities in thailand","international programs thailand","study in thailand life"]},
  {"slug":"asia-medicine-dentistry-and-health-sciences","label":"Health Sciences in Asia","title":"Medicine, Dentistry & Health Sciences in Asia","description":"Studying medicine and the health sciences across Asia — framed on India’s NEET and NMC rules where clinical practice is involved.","group":"study-in-asia","region":"east-southeast-asia","guideSlugs":["studying-dentistry-bds-across-asia","studying-pharmacy-across-asia","studying-veterinary-science-across-asia","public-health-and-epidemiology-study-across-asia","physiotherapy-and-rehabilitation-sciences-across-asia"],"examSlugs":["ielts","toefl"],"keywords":["dentistry in asia","pharmacy asia","nursing abroad india","veterinary asia"]},
  {"slug":"asia-engineering-disciplines-in-depth","label":"Engineering in Asia","title":"Engineering Disciplines Across Asia","description":"Where to study specific engineering disciplines across East & Southeast Asia.","group":"study-in-asia","region":"east-southeast-asia","guideSlugs":["studying-civil-engineering-across-asia","studying-mechanical-engineering-across-asia","studying-electrical-and-electronics-engineering-across-asia","studying-chemical-engineering-across-asia","studying-aerospace-engineering-across-asia"],"examSlugs":["ielts","toefl","gre"],"keywords":["civil engineering asia","mechanical engineering asia","aerospace engineering asia"]},
  {"slug":"asia-computing-ai-and-data-in-depth","label":"Computing & AI in Asia","title":"Computing, AI & Data Science Across Asia","description":"Where to study computing, AI, data science and related fields across Asia.","group":"study-in-asia","region":"east-southeast-asia","guideSlugs":["cybersecurity-and-information-security-degrees-across-asia","game-development-and-interactive-media-degrees-across-asia","software-engineering-vs-computer-science-degrees-in-asia","artificial-intelligence-and-machine-learning-masters-degrees-across-asia","fintech-and-financial-technology-degrees-across-asia"],"examSlugs":["ielts","toefl","gre"],"keywords":["computer science asia","artificial intelligence asia","data science asia","cybersecurity asia"]},
  {"slug":"asia-business-finance-and-management-in-depth","label":"Business in Asia","title":"Business, Finance & Management Across Asia","description":"Where to study business, finance and management subjects across Asia.","group":"study-in-asia","region":"east-southeast-asia","guideSlugs":["undergraduate-finance-and-banking-degrees-across-asia","accounting-degrees-and-professional-pathways-across-asia","hospitality-and-tourism-management-degrees-across-asia","supply-chain-and-logistics-degrees-across-asia","gmat-and-gre-for-business-masters-in-asia"],"examSlugs":["ielts","toefl","gmat","gre"],"keywords":["business degree asia","finance asia","hospitality management asia"]},
  {"slug":"asia-arts-design-media-and-architecture","label":"Arts & Design in Asia","title":"Arts, Design, Media & Architecture Across Asia","description":"Where to study creative and design subjects across Asia.","group":"study-in-asia","region":"east-southeast-asia","guideSlugs":["studying-animation-film-and-game-art-across-asia","studying-fashion-and-textile-design-across-asia","studying-architecture-across-asia","studying-music-and-performing-arts-across-asia","studying-fine-arts-and-studio-art-across-asia"],"examSlugs":["ielts","toefl"],"keywords":["design study asia","animation film asia","architecture asia","fashion asia"]},
  {"slug":"asia-postgraduate-research-and-phd","label":"Postgrad & PhD in Asia","title":"Postgraduate, Research & PhD Study Across Asia","description":"Master’s, PhD and research study across Asia — routes, funding and finding a supervisor.","group":"study-in-asia","region":"east-southeast-asia","guideSlugs":["gre-and-gmat-for-postgraduate-study-in-asia","how-to-find-and-approach-a-phd-supervisor-in-asia","taught-vs-research-masters-in-asia-explained","doing-a-phd-in-east-and-southeast-asia","research-assistantships-and-funded-phd-positions-in-asia"],"examSlugs":["ielts","toefl","gre","gmat"],"keywords":["masters in asia","phd in asia","research funding asia","find a supervisor asia"]},
  {"slug":"asia-application-practicalities-and-documents","label":"Applying: Practicalities","title":"Application Practicalities & Documents for Asia","description":"The practical side of applying across Asia — documents, credential evaluation, pathways and transfers.","group":"study-in-asia","region":"east-southeast-asia","guideSlugs":["apostille-and-document-attestation-for-studying-in-asia","credential-evaluation-and-degree-equivalence-for-asian-universities","foundation-and-pathway-programs-into-asian-universities","transferring-universities-and-credit-transfer-in-asia","taking-a-gap-year-before-studying-in-asia"],"examSlugs":["ielts","toefl"],"keywords":["apostille attestation asia","credential evaluation","foundation pathway asia","transfer university asia"]},
  {"slug":"asia-after-graduation-and-back-to-india","label":"After Graduation","title":"After Graduation in Asia & Returning to India","description":"What happens after your Asian degree — staying on, or bringing the qualification back to India.","group":"study-in-asia","region":"east-southeast-asia","guideSlugs":["getting-your-asian-degree-recognised-in-india-aiu-equivalence","building-a-career-in-india-with-an-asian-degree","returning-to-india-vs-staying-in-asia-after-graduation","finding-your-first-graduate-job-after-studying-in-asia","japan-highly-skilled-professional-points-based-permanent-residence"],"examSlugs":["ielts","toefl"],"keywords":["pr pathways asia","foreign degree recognition india aiu","jobs after study in asia"]},
/* ==EASTASIA_HUBS_P3_END== */
/* ==EASTASIA_HUBS_P2_START== */
  {"slug":"japan-universities-in-depth","label":"Japan: Universities","title":"Japanese Universities In Depth","description":"Admission guides for Japan’s leading universities beyond Tokyo, Kyoto and Osaka — English (SGU) and Japanese-track entry for international students.","group":"study-in-asia","region":"east-southeast-asia","guideSlugs":["waseda-university-admission-guide","keio-university-admission-guide","institute-of-science-tokyo-admission-guide","tohoku-university-admission-guide","nagoya-university-admission-guide","hitotsubashi-university-admission-guide","hokkaido-kyushu-and-tsukuba-admission-guide"],"examSlugs":["ielts","toefl"],"keywords":["japanese universities","tohoku university admission","waseda keio admission","study in japan"]},
  {"slug":"japan-fields-and-careers","label":"Japan: Fields","title":"Studying Specific Fields in Japan","description":"What it is like to study particular subjects in Japan and where they can lead — engineering, computing, business, sciences, medicine, design and Japanese studies.","group":"study-in-asia","region":"east-southeast-asia","guideSlugs":["studying-engineering-in-japan","studying-computer-science-and-it-in-japan","studying-business-and-economics-in-japan","studying-natural-sciences-in-japan","studying-medicine-and-health-sciences-in-japan","studying-architecture-and-design-in-japan","studying-japanese-studies-and-humanities-in-japan"],"examSlugs":["ielts","toefl"],"keywords":["study engineering in japan","computer science japan","business degree japan"]},
  {"slug":"japan-scholarships-and-funding-in-depth","label":"Japan: Scholarships","title":"Japan Scholarships & Funding In Depth","description":"Funding a Japanese degree beyond MEXT — JASSO awards, university and private/foundation scholarships, tuition-reduction systems and how to fund a PhD.","group":"study-in-asia","region":"east-southeast-asia","guideSlugs":["jasso-honors-scholarship-for-students-in-japan","mext-university-recommendation-vs-embassy-recommendation","university-scholarships-at-japanese-universities","private-and-foundation-scholarships-in-japan","tuition-waivers-and-reductions-at-japanese-universities","funding-a-masters-vs-phd-in-japan","when-to-apply-for-scholarships-in-japan-before-vs-after-enrollment"],"examSlugs":["ielts","toefl"],"keywords":["jasso scholarship","japan university scholarships","fund phd in japan"]},
  {"slug":"japan-student-life-work-and-cities","label":"Japan: Life & Cities","title":"Student Life, Work & Cities in Japan","description":"Living as a student in Japan — the main student cities, accommodation, part-time work, health insurance and settling in.","group":"study-in-asia","region":"east-southeast-asia","guideSlugs":["finding-student-housing-in-japan-dorms-share-houses-and-apartments","finding-a-part-time-job-arubaito-in-japan","national-health-insurance-and-healthcare-for-students-in-japan","settling-into-japan-residence-card-city-hall-bank-and-phone","living-in-tokyo-as-an-international-student","where-to-study-in-japan-comparing-tokyo-osaka-and-regional-cities","cultural-adjustment-and-daily-life-for-students-in-japan"],"examSlugs":["ielts","toefl"],"keywords":["student life japan","living in tokyo student","part-time work japan"]},
  {"slug":"singapore-universities-and-pathways-in-depth","label":"Singapore: Universities","title":"Singapore Universities & Pathways In Depth","description":"Beyond NUS and NTU — SUTD, SIT and SUSS, the private universities, and the polytechnic and diploma routes into a Singapore degree.","group":"study-in-asia","region":"east-southeast-asia","guideSlugs":["singapore-university-of-technology-and-design-admission-guide","singapore-institute-of-technology-admission-guide","singapore-university-of-social-sciences-admission-guide","private-universities-in-singapore-sim-psb-kaplan-jcu-guide","polytechnic-diploma-to-university-degree-pathway-singapore","foundation-and-diploma-pathways-to-singapore-universities","part-time-and-working-adult-degrees-in-singapore"],"examSlugs":["ielts","toefl"],"keywords":["sutd sit suss","private universities singapore","polytechnic to university singapore"]},
  {"slug":"singapore-fields-and-careers","label":"Singapore: Fields","title":"Studying Specific Fields in Singapore","description":"Studying particular subjects in Singapore — computing, business and finance, engineering, life sciences, law, hospitality and design.","group":"study-in-asia","region":"east-southeast-asia","guideSlugs":["study-computing-and-artificial-intelligence-in-singapore","study-business-finance-and-accountancy-in-singapore","study-engineering-in-singapore","study-medicine-and-life-sciences-in-singapore","study-law-in-singapore","study-hospitality-and-tourism-management-in-singapore","study-communication-media-and-design-in-singapore"],"examSlugs":["ielts","toefl","gre","gmat"],"keywords":["computing degree singapore","business finance singapore","engineering singapore"]},
  {"slug":"singapore-scholarships-costs-and-work","label":"Singapore: Funding & Work","title":"Singapore Scholarships, Costs & Work In Depth","description":"Paying for and working around a Singapore degree — the ASEAN scholarship, university awards, living costs, financing, work rules and staying on.","group":"study-in-asia","region":"east-southeast-asia","guideSlugs":["asean-undergraduate-scholarship-for-singapore-guide","cost-of-living-in-singapore-for-students-breakdown","financing-your-studies-in-singapore-loans-and-payment-options","internship-and-industrial-attachment-rules-for-students-in-singapore","employment-pass-and-work-pass-routes-after-studying-in-singapore","permanent-residence-pathway-in-singapore-for-graduates","nus-and-ntu-university-scholarships-for-international-students"],"examSlugs":["ielts","toefl"],"keywords":["asean scholarship","cost of living singapore student","work after study singapore"]},
  {"slug":"korea-universities-in-depth","label":"Korea: Universities","title":"Korean Universities In Depth","description":"Admission guides for Korea’s leading universities — Korea University, Yonsei, KAIST, POSTECH, SKKU, Hanyang and Kyung Hee.","group":"study-in-asia","region":"east-southeast-asia","guideSlugs":["korea-university-admission-guide","yonsei-university-admission-guide","postech-admission-guide","sungkyunkwan-university-skku-admission-guide","hanyang-university-admission-guide","kyung-hee-university-admission-guide","korea-university-vs-yonsei-university-how-to-choose"],"examSlugs":["ielts","toefl"],"keywords":["korea university yonsei admission","kaist postech","study in korea universities"]},
  {"slug":"korea-fields-and-careers","label":"Korea: Fields","title":"Studying Specific Fields in South Korea","description":"Studying particular subjects in South Korea — engineering, IT, business, design and the arts, sciences and medicine.","group":"study-in-asia","region":"east-southeast-asia","guideSlugs":["studying-engineering-in-south-korea","studying-computer-science-and-it-in-south-korea","studying-business-and-economics-in-south-korea","studying-design-arts-and-media-in-south-korea","studying-natural-sciences-in-south-korea","studying-medicine-and-health-sciences-in-south-korea","studying-korean-studies-in-south-korea"],"examSlugs":["ielts","toefl"],"keywords":["engineering in korea","design study korea","business degree korea"]},
  {"slug":"korea-scholarships-visas-and-life","label":"Korea: Funding, Visas & Life","title":"Korea Scholarships, Visas & Student Life In Depth","description":"Funding, visas and daily life in South Korea — GKS in depth, university scholarships, the D-2 and D-10 visas, and living in Seoul or Busan.","group":"study-in-asia","region":"east-southeast-asia","guideSlugs":["gks-undergraduate-vs-graduate-track-differences","korean-university-scholarships-and-tuition-reductions","korea-d2-visa-sub-categories-explained","korea-d10-job-seeking-visa-explained","student-housing-in-korea-dorms-goshiwon-one-room","health-insurance-for-international-students-in-korea","student-cities-in-korea-seoul-busan-daejeon"],"examSlugs":["ielts","toefl"],"keywords":["gks scholarship deep","korea d-2 d-10 visa","living in seoul student"]},
  {"slug":"hong-kong-universities-and-admission-in-depth","label":"Hong Kong: Universities","title":"Hong Kong Universities & Admission In Depth","description":"Beyond HKU and HKUST — CUHK, City University, PolyU and HKBU, plus how non-JUPAS admission and the HKPFS work.","group":"study-in-asia","region":"east-southeast-asia","guideSlugs":["chinese-university-of-hong-kong-admission-guide","city-university-of-hong-kong-admission-guide","hong-kong-polytechnic-university-admission-guide","hong-kong-baptist-university-admission-guide","non-jupas-application-route-for-hong-kong-universities-explained","associate-degree-and-senior-year-entry-in-hong-kong-explained","hong-kong-phd-fellowship-scheme-hkpfs-guide"],"examSlugs":["ielts","toefl"],"keywords":["cuhk cityu polyu admission","non-jupas","hkpfs"]},
  {"slug":"taiwan-universities-and-scholarships-in-depth","label":"Taiwan: Universities","title":"Taiwan Universities & Scholarships In Depth","description":"Beyond National Taiwan University — NCKU, NTHU, NYCU and NTUST, and the MOE, ICDF and Huayu scholarships in depth.","group":"study-in-asia","region":"east-southeast-asia","guideSlugs":["national-cheng-kung-university-admission-guide","national-tsing-hua-university-taiwan-admission-guide","national-yang-ming-chiao-tung-university-admission-guide","taiwan-tech-ntust-admission-guide","huayu-enrichment-scholarship-guide","taiwan-moe-scholarship-application-guide","taiwan-university-scholarships-and-tuition-waivers-guide"],"examSlugs":["ielts","toefl"],"keywords":["ncku nthu nycu","taiwan moe scholarship","huayu scholarship"]},
  {"slug":"malaysia-universities-and-branch-campuses-in-depth","label":"Malaysia: Universities","title":"Malaysia Universities & Branch Campuses In Depth","description":"Malaysia’s public universities and the UK/Australian/Chinese branch campuses, plus the leading private universities.","group":"study-in-asia","region":"east-southeast-asia","guideSlugs":["universiti-malaya-um-admission-guide","upm-ukm-usm-utm-public-university-admission-guide","monash-university-malaysia-admission-guide","nottingham-and-heriot-watt-malaysia-admission-guide","xiamen-university-malaysia-admission-guide","taylors-and-sunway-university-admission-guide","asia-pacific-university-apu-admission-guide"],"examSlugs":["ielts","toefl"],"keywords":["universiti malaya upm ukm","monash nottingham malaysia","private universities malaysia"]},
  {"slug":"thailand-and-philippines-study-in-depth","label":"Thailand & Philippines","title":"Studying in Thailand & the Philippines In Depth","description":"International programs in Thailand and study routes in the Philippines, including nursing and the practicalities of each.","group":"study-in-asia","region":"east-southeast-asia","guideSlugs":["chulalongkorn-university-admission-guide","mahidol-university-and-muic-admission-guide","thammasat-university-international-programs-guide","university-of-the-philippines-admission-and-upcat-guide","ust-ateneo-and-de-la-salle-admission-guide","studying-nursing-in-the-philippines-guide","philippines-student-visa-9f-and-special-study-permit-guide"],"examSlugs":["ielts","toefl"],"keywords":["study in thailand international programs","universities in philippines","nursing philippines"]},
  {"slug":"china-universities-and-scholarships-in-depth","label":"China: Universities","title":"Chinese Universities & Scholarships In Depth","description":"China’s leading universities and how CSC and other scholarships and the HSK work — neutral, study-facts only.","group":"study-in-asia","region":"east-southeast-asia","guideSlugs":["fudan-university-admission-for-international-students","shanghai-jiao-tong-university-admission-for-international-students","zhejiang-university-admission-for-international-students","university-of-science-and-technology-of-china-admission-guide","nanjing-university-admission-for-international-students","csc-scholarship-types-a-b-c-and-application-channels","scholarships-in-china-beyond-csc"],"examSlugs":["ielts","toefl"],"keywords":["fudan sjtu zhejiang admission","csc scholarship types","hsk levels"]},
  {"slug":"mbbs-in-china-and-asia-in-depth","label":"MBBS in Asia (India-side)","title":"MBBS in China & Asia In Depth (India-side rules)","description":"Pursuing MBBS in China or the Philippines from India — framed entirely on India’s NEET and NMC rules, FMGE/NExT and choosing a recognised university.","group":"study-in-asia","region":"east-southeast-asia","guideSlugs":["nmc-eligibility-and-fmg-rules-for-studying-mbbs-abroad","fmge-vs-next-for-foreign-medical-graduates-explained","registering-with-a-state-medical-council-after-foreign-mbbs","how-to-choose-a-recognised-medical-university-abroad","english-medium-mbbs-in-china-and-the-chinese-language-requirement","bs-pre-med-and-md-pathway-for-mbbs-in-the-philippines","nursing-and-allied-health-studies-in-asia-from-india"],"examSlugs":["ielts","toefl"],"keywords":["mbbs in china","mbbs philippines","fmge next","mbbs abroad nmc"]},
  {"slug":"asian-language-and-english-tests-in-depth","label":"Language & Tests","title":"Language & English Tests for Asia In Depth","description":"The language tests that open Asian universities — JLPT, TOPIK, HSK and TOCFL — and where English-taught study is possible.","group":"study-in-asia","region":"east-southeast-asia","guideSlugs":["jlpt-levels-n5-to-n1-and-how-to-prepare","topik-levels-and-how-to-prepare","hsk-levels-and-how-to-prepare","tocfl-taiwan-chinese-proficiency-test-guide","duolingo-english-test-for-asian-universities","english-taught-degree-programs-in-taiwan","japanese-language-school-pathway-to-university-in-japan"],"examSlugs":["ielts","toefl"],"keywords":["jlpt levels","topik preparation","hsk levels","english-taught asia"]},
  {"slug":"fields-and-subjects-across-asia","label":"Fields Across Asia","title":"Studying Fields & Subjects Across Asia","description":"Where to study a given subject across East & Southeast Asia — engineering, computing, business, medicine, design and more, compared by destination.","group":"study-in-asia","region":"east-southeast-asia","guideSlugs":["studying-engineering-across-asia-degree-structures-and-routes","studying-computer-science-and-ai-across-asia","studying-business-and-management-across-asia-undergraduate-to-mba","studying-medicine-and-health-sciences-across-asia-study-side-overview","studying-design-and-creative-arts-across-asia-portfolios-and-programs","studying-data-science-and-analytics-across-asia","studying-sustainability-and-environmental-sciences-across-asia"],"examSlugs":["ielts","toefl","gre","gmat"],"keywords":["engineering in asia","mba in asia","computer science asia"]},
  {"slug":"working-staying-and-costs-across-asia","label":"Work, Stay & Costs","title":"Working, Staying & Costs Across Asia","description":"The money and post-study picture across Asia — costs by city, post-study work and residence routes by country, internships and financing.","group":"study-in-asia","region":"east-southeast-asia","guideSlugs":["post-study-work-routes-across-asia-compared","permanent-residency-and-long-term-stay-after-studying-in-asia","internships-and-work-integrated-learning-in-asia","cost-of-living-compared-across-major-asian-student-cities","education-loans-for-studying-in-asia","budgeting-and-managing-money-as-a-student-in-asia","scholarships-vs-self-funding-for-studying-in-asia"],"examSlugs":["ielts","toefl"],"keywords":["cost of living asia students","post-study work asia","education loan study asia"]},
  {"slug":"choosing-and-comparing-asian-destinations","label":"Compare Destinations","title":"Choosing & Comparing Asian Study Destinations","description":"Neutral, decide-by-your-goals comparisons between Asian study destinations to help you shortlist.","group":"study-in-asia","region":"east-southeast-asia","guideSlugs":["japan-vs-south-korea-for-international-students","singapore-vs-hong-kong-for-international-students","singapore-vs-malaysia-for-international-students","china-vs-philippines-for-mbbs-how-to-decide","studying-in-asia-vs-studying-in-the-west","most-affordable-countries-to-study-in-asia","east-asia-vs-southeast-asia-for-international-students"],"examSlugs":["ielts","toefl"],"keywords":["japan vs korea","singapore vs hong kong","cheapest study in asia"]},
/* ==EASTASIA_HUBS_P2_END== */
/* ==EASTASIA_HUBS_START== */
  {"slug":"east-southeast-asia-admissions","label":"Asia Admissions","title":"Applying to Universities in East & Southeast Asia","description":"How admissions work across East and Southeast Asia — applying directly to each university, finding English-taught degrees, English tests, timelines, documents, SOPs and choosing your destination.","group":"study-in-asia","region":"east-southeast-asia","guideSlugs":["how-to-apply-to-universities-in-asia-from-india","english-taught-degrees-in-east-and-southeast-asia","english-tests-for-studying-in-asia-ielts-toefl","application-timeline-and-intakes-for-asian-universities","document-and-credential-requirements-for-asian-universities","writing-a-statement-of-purpose-for-asian-universities","letters-of-recommendation-for-asian-university-applications","undergraduate-vs-postgraduate-admission-in-asia","how-to-choose-a-study-destination-in-asia","do-you-need-to-learn-the-local-language-to-study-in-asia","education-agents-and-avoiding-admission-scams-in-asia","cost-of-studying-in-east-and-southeast-asia-overview"],"examSlugs":["ielts","toefl"],"keywords":["study in asia","asian university admissions","english-taught degrees asia","apply to asian universities from india"]},
  {"slug":"east-southeast-asia-universities","label":"Asian Universities","title":"Top Universities in East & Southeast Asia","seoTitle":"Top Universities in Japan, Singapore, Korea, Hong Kong, Taiwan, Malaysia & China","description":"The region’s leading universities and how international students get in — NUS, NTU, the University of Tokyo, Kyoto, KAIST, Seoul National, HKU and HKUST — with rankings explained and field strengths.","group":"study-in-asia","region":"east-southeast-asia","guideSlugs":["top-universities-in-east-and-southeast-asia","national-university-of-singapore-admission-guide","nanyang-technological-university-admission-guide","university-of-tokyo-admission-guide","kyoto-university-admission-guide","kaist-admission-guide","seoul-national-university-admission-guide","university-of-hong-kong-admission-guide","hkust-admission-guide","how-university-rankings-work-for-asian-universities","best-universities-in-asia-for-engineering-and-technology","best-universities-in-asia-for-business-and-mba"],"examSlugs":["ielts","toefl","gre","gmat"],"keywords":["top universities in asia","best asian universities","nus ntu admission","university of tokyo admission"]},
  {"slug":"study-in-japan","label":"Study in Japan","title":"Study in Japan: Universities, MEXT, Visas & Costs","description":"A complete guide to studying in Japan — English-taught SGU programs, the MEXT scholarship, EJU and JLPT, university admission, the student visa, costs, part-time work and student life.","group":"study-in-asia","region":"east-southeast-asia","guideSlugs":["how-to-study-in-japan-from-india","mext-scholarship-guide-for-indian-students","japanese-government-scholarship-application-process","study-in-japan-in-english-sgu-and-g30-programs","how-japanese-university-admission-works","eju-examination-for-japanese-universities-explained","jlpt-japanese-language-proficiency-test-guide","japan-student-visa-guide","cost-of-studying-in-japan","part-time-work-rules-for-students-in-japan","scholarships-for-international-students-in-japan","top-universities-in-japan-for-international-students","research-student-and-graduate-study-route-in-japan","student-life-and-accommodation-in-japan","how-to-study-medicine-or-engineering-in-japan","post-study-work-and-staying-in-japan-after-graduation"],"examSlugs":["ielts","toefl"],"keywords":["study in japan","mext scholarship","study in japan from india","japan student visa","jlpt"]},
  {"slug":"study-in-singapore","label":"Study in Singapore","title":"Study in Singapore: NUS, NTU, Tuition Grant & Student Pass","description":"How to study in Singapore — applying to NUS, NTU and SMU, the MOE Tuition Grant and service bond, the Student Pass, costs, scholarships, work rules and student life.","group":"study-in-asia","region":"east-southeast-asia","guideSlugs":["how-to-study-in-singapore-from-india","national-university-of-singapore-vs-ntu-how-to-choose","singapore-university-admission-requirements-explained","moe-tuition-grant-and-service-bond-explained","student-pass-for-singapore-guide","cost-of-studying-in-singapore","scholarships-for-international-students-in-singapore","part-time-work-rules-for-students-in-singapore","singapore-management-university-and-smu-admission-guide","polytechnics-vs-universities-in-singapore","student-life-and-accommodation-in-singapore","best-courses-to-study-in-singapore","post-study-work-and-staying-in-singapore-after-graduation","masters-and-mba-in-singapore-guide"],"examSlugs":["ielts","toefl","gre","gmat"],"keywords":["study in singapore","nus admission","ntu admission","singapore tuition grant","singapore student pass"]},
  {"slug":"study-in-south-korea","label":"Study in South Korea","title":"Study in South Korea: GKS, TOPIK, Universities & Visas","description":"Studying in South Korea — the Global Korea Scholarship, TOPIK and English-taught programs, SKY and KAIST admission, the D-2 student visa, costs, work rules and student life.","group":"study-in-asia","region":"east-southeast-asia","guideSlugs":["how-to-study-in-south-korea-from-india","gks-korean-government-scholarship-guide","topik-test-of-proficiency-in-korean-guide","english-taught-programs-in-south-korea","how-korean-university-admission-works","sky-universities-and-kaist-postech-in-korea","south-korea-d2-student-visa-guide","cost-of-studying-in-south-korea","scholarships-for-international-students-in-south-korea","part-time-work-rules-for-students-in-south-korea","student-life-and-accommodation-in-south-korea","post-study-work-and-staying-in-korea-after-graduation"],"examSlugs":["ielts","toefl"],"keywords":["study in south korea","gks scholarship","topik","korea d-2 student visa"]},
  {"slug":"study-in-hong-kong-and-taiwan","label":"Hong Kong & Taiwan","title":"Study in Hong Kong & Taiwan","description":"Studying in Hong Kong and Taiwan — English-medium admission, the MOE and ICDF scholarships, student visas and the ARC, costs, post-study work (IANG) and learning Mandarin.","group":"study-in-asia","region":"east-southeast-asia","guideSlugs":["how-to-study-in-hong-kong-from-india","hong-kong-university-admission-for-international-students","hong-kong-student-visa-guide","cost-of-studying-in-hong-kong","scholarships-for-international-students-in-hong-kong","post-study-work-in-hong-kong-iang","how-to-study-in-taiwan-from-india","taiwan-moe-and-icdf-scholarships-guide","taiwan-university-admission-for-international-students","taiwan-resident-visa-and-arc-for-students","cost-of-studying-in-taiwan","learning-mandarin-for-study-in-taiwan-and-hong-kong"],"examSlugs":["ielts","toefl"],"keywords":["study in hong kong","study in taiwan","hong kong universities","taiwan scholarships"]},
  {"slug":"study-in-malaysia-and-southeast-asia","label":"Malaysia & SE Asia","title":"Study in Malaysia, Thailand & the Philippines","description":"Affordable study across Southeast Asia — Malaysia’s public universities and international branch campuses (EMGS), Thailand’s international programs, the Philippines, student visas and costs.","group":"study-in-asia","region":"east-southeast-asia","guideSlugs":["how-to-study-in-malaysia-from-india","international-branch-campuses-in-malaysia","malaysia-student-visa-and-emgs-guide","cost-of-studying-in-malaysia","public-vs-private-universities-in-malaysia","scholarships-for-international-students-in-malaysia","how-to-study-in-thailand-from-india","international-programs-and-universities-in-thailand","thailand-student-visa-guide","how-to-study-in-the-philippines-from-india","cost-of-studying-in-the-philippines","student-life-in-southeast-asia-malaysia-thailand-philippines"],"examSlugs":["ielts","toefl"],"keywords":["study in malaysia","study in thailand","study in philippines","malaysia branch campuses"]},
  {"slug":"study-in-china-and-mbbs-in-asia","label":"China & MBBS in Asia","title":"Study in China & MBBS in Asia","description":"Studying in mainland China — the CSC scholarship, HSK, English-taught programs, the X visa and costs — plus the India-side NEET and NMC rules for pursuing MBBS in China or the Philippines.","group":"study-in-asia","region":"east-southeast-asia","guideSlugs":["how-to-study-in-china-from-india","csc-chinese-government-scholarship-guide","hsk-chinese-proficiency-test-guide","english-taught-programs-in-china","china-x-student-visa-guide","cost-of-studying-in-china","mbbs-in-china-and-philippines-for-indian-students","mbbs-in-china-for-indian-students","mbbs-in-the-philippines-for-indian-students","top-universities-in-china-for-international-students"],"examSlugs":["ielts","toefl"],"keywords":["study in china","csc scholarship","mbbs in china","mbbs in philippines","mbbs abroad neet nmc"]},
/* ==EASTASIA_HUBS_END== */
/* ==USAP3_HUBS_START== */
{
...
},
{
  ...
  "seoTitle":"MCAT, DAT, OAT & Score Sending: US Admission Tests Explained",
...
},
{
  ...
  "seoTitle":"Cybersecurity, Actuarial Science, Aerospace & Architecture Majors in the USA",
...
},
{
  ...
  "seoTitle":"RUDN, Kazan Federal, SPbU & Bauman: Russian University Admission Guides",
...
},
{
  ...
  "seoTitle":"Pharmacy, Aviation & Nursing Degrees in Russia & the CIS",
...
},
{
  ...
  "seoTitle":"BITS Pilani Dubai, Manipal Dubai, Heriot-Watt & Birmingham Dubai: Admission Guides",
...
},
{
  ...
  "seoTitle":"Politecnico di Milano, RWTH Aachen, TU Wien & Erasmus Rotterdam: Admission Guides",
...
},
{
  ...
  "seoTitle":"Study in Poland, Hungary, Czechia, Portugal & Austria: Complete Guides",
...
},
{
  ...
  "seoTitle":"Southampton, Queen Mary, Nottingham & Coventry: UK University Admission Guides",
...
},
{
  ...
  "seoTitle":"SQE Solicitor, Optometry, Actuary & Pilot Routes in the UK & Ireland",
...
},
{
  ...
  "seoTitle":"McMaster, Windsor, York & Alberta: Canadian University Admission Guides",
...
},
{
  ...
  "seoTitle":"Spousal Work Permits, Express Entry Draws & IEC: Canada Pathways for Students",
...
},
{
  ...
  "seoTitle":"Dentistry, Pharmacy, Accounting & Architecture: Study Programs in Canada",
...
},
{
  ...
  "seoTitle":"Studying in Adelaide, Canberra, Wellington & Christchurch: Student City Guides",
...
},
{
  ...
  "seoTitle":"Robotics, Instrumentation, Mining & Petroleum Engineering: Branch Guides",
...
},
{
  ...
  "seoTitle":"Courses After 12th Without Maths, With PCMB, Short-Term & Integrated Degrees",
