...
export const metadata: Metadata = {
  ...
  alternates: {
    canonical: 'https://www.globalstudyboard.com/about',
    languages: {
      en: 'https://www.globalstudyboard.com/about',
      hi: 'https://www.globalstudyboard.com/hi/about',
      'x-default': 'https://www.globalstudyboard.com/about',
    },
  },
  openGraph: {
    type: 'website',
