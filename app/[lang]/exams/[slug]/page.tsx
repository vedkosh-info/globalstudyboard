...
export function generateStaticParams() {
  ...
  return locales.flatMap((lang) =>
    ENTRANCE_EXAMS.map((e) => ({ lang, slug: e.slug }))
  );
}
...
export async function generateMetadata({ params }: Props): Promise<Metadata> {
  ...
  return {
    ...
    alternates: {
      canonical: `https://www.globalstudyboard.com/exams/${exam.slug}`,
      languages: {
        en: `https://www.globalstudyboard.com/exams/${exam.slug}`,
        hi: `https://www.globalstudyboard.com/hi/exams/${exam.slug}`,
        'x-default': `https://www.globalstudyboard.com/exams/${exam.slug}`,
      },
    },
    openGraph: {
      type: 'article',
