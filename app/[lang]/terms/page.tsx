...
export const metadata: Metadata = {
  ...
  alternates: {
    canonical: 'https://www.globalstudyboard.com/terms',
    languages: {
      en: 'https://www.globalstudyboard.com/terms',
      hi: 'https://www.globalstudyboard.com/hi/terms',
      'x-default': 'https://www.globalstudyboard.com/terms',
    },
  },
  openGraph: {
    type: 'website',
