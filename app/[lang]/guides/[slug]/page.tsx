...
export async function generateMetadata({ params }: Props): Promise<Metadata> {
  ...
  return {
    ...
    alternates: {
      canonical: `https://www.globalstudyboard.com/guides/${guide.slug}`,
      languages: {
        en: `https://www.globalstudyboard.com/guides/${guide.slug}`,
        hi: `https://www.globalstudyboard.com/hi/guides/${guide.slug}`,
        'x-default': `https://www.globalstudyboard.com/guides/${guide.slug}`,
      },
    },
    openGraph: {
      type: 'article',
...
export default async function GuideDetailPage({ params }: Props) {
  ...
  const articleLd = {
    ...
    author: { '@type': 'Organization', name: 'GlobalStudyBoard' },
    publisher: { '@type': 'Organization', name: 'GlobalStudyBoard' },
