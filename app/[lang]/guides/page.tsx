...
export const metadata: Metadata = {
  ...
  alternates: {
    canonical: 'https://www.globalstudyboard.com/guides',
    languages: {
      en: 'https://www.globalstudyboard.com/guides',
      hi: 'https://www.globalstudyboard.com/hi/guides',
      'x-default': 'https://www.globalstudyboard.com/guides',
    },
  },
  openGraph: {
    type: 'website',
