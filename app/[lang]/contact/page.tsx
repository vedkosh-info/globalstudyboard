...
export const metadata: Metadata = {
  ...
  alternates: {
    canonical: 'https://www.globalstudyboard.com/contact',
    languages: {
      en: 'https://www.globalstudyboard.com/contact',
      hi: 'https://www.globalstudyboard.com/hi/contact',
      'x-default': 'https://www.globalstudyboard.com/contact',
    },
  },
  openGraph: {
    type: 'website',
