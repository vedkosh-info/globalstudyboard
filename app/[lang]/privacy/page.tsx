...
export const metadata: Metadata = {
  ...
  alternates: {
    canonical: 'https://www.globalstudyboard.com/privacy',
    languages: {
      en: 'https://www.globalstudyboard.com/privacy',
      hi: 'https://www.globalstudyboard.com/hi/privacy',
      'x-default': 'https://www.globalstudyboard.com/privacy',
    },
  },
  openGraph: {
    type: 'website',
